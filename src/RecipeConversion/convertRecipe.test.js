...
import ingredientManagerSingleton, {globalIngredientManager, IngredientManager, objectTest} from './DataStructures/ingredient';
...
//   const result = parseRecipe(prepSteps, ingredientManager);
...
//   const result = parseRecipe(prepSteps, ingredientManagerSingleton);
//   expect(result).toEqual(expected);
// });
